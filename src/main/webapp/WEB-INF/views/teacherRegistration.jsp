...
<body>
	...
	<form:form method="POST" modelAttribute="teacher">
		...
		<table>
		    ...
		    <tr>
				<td><label for="name">Teacher Id: </label> </td>
				<td><form:input path="teacherId" id="teacherId"/></td>
				<td><form:errors path="teacherId" cssClass="error"/></td>
		    </tr>
	...
	<br/>
	<br/>
	Go back to <a href="<c:url value='/listTeachers' />">List of All Teachers</a>
</body>
</html>